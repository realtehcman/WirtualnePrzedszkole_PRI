        ...
        <div className="row">
          <div className="col-md-3 border-right">
            <div className="d-flex flex-column align-items-center text-center p-3 py-5">
              ...
              />
              <div className="dlt">            <button className="btn btn-danger" onClick={() => deleteAvatar(user)}>{t('delete_profile_picture')}</button>
              </div>
                ...
                <div className="col-md-12">
                  ...
                  <table className="children">
                    ...
                    {user.children.map((child) => (
                        ...
                        >
                          <td id="td--children_user">{child.name}</td>
                          <td id="td--children_user">{child.lastName}</td>
                          <td id="td--children_user">{child.classId}</td>
